...
router.get('/get-ble-locked-by-orga/:orgaId', getLockedDevicesByOrga) //? not used ?
...
router.get('/get-all-locked-devices-by-orga/:orgaId', getAllLockedDevicesByOrga)
